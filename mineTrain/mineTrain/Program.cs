...
namespace mineTrain
{
    class Program
    {
        ...
        public static Stack<Train> History2 = new Stack<Train>();
        ...
        {
            List<Train> alreadyDepartedTrains = new List<Train>(History2);
            foreach (var train in alreadyDepartedTrains)
            {
